...
DynamicWindowApproach::DynamicWindowApproach ( ) : nh_(), pnh_("~") {
	...
	setStepValue( pnh_.param<int>( "predict_step", 30 ), pnh_.param<double>( "sampling_time", 0.1 ) );
	setVelocityLimit(
        pnh_.param<int>( "min_linear", 0.2 ),
        pnh_.param<double>( "max_linear", 2.0 ),
        pnh_.param<int>( "min_angular_deg", -60 ) * M_PI / 180.0,
        pnh_.param<double>( "max_angular_deg", 60 ) * M_PI / 180.0,
        pnh_.param<double>( "velocity_step", 7.0 ),
        pnh_.param<double>( "angle_velocity_step", 15.0 ) );
	setWeight( pnh_.param<double>( "weight_heading", 1.0 ), pnh_.param<double>( "weight_obstacle", 1.0 ), pnh_.param<double>( "weight_velocity", 2.0 ));
	setCostDistance ( pnh_.param<double>( "obstacle_cost_radius", 0.35 ) );
	setDisplayFlag( pnh_.param<bool>( "display_optimal_path", false ), pnh_.param<bool>( "display_all_path", false ) );
	...
	std::cout << "\n========================================\n[ path generator parameters ]"
		...
		<< "\n\n< DWA : VelocityLimit >"
		<< "\n  * min_linear             : " << pnh_.param<double>( "min_linear", 0.1 )
		<< "\n  * max_linear             : " << pnh_.param<double>( "max_linear", 1.2 )
		<< "\n  * min_angular_deg        : " << pnh_.param<double>( "min_angular_deg", -60.0 ) * M_PI / 180.0
		<< "\n  * max_angular_deg        : " << pnh_.param<double>( "max_angular_deg", 60.0 ) * M_PI / 180.0
		<< "\n  * velocity_step          : " << pnh_.param<double>( "velocity_step", 7.0 )
		<< "\n  * angle_velocity_step    : " << pnh_.param<double>( "angle_velocity_step", 15.0 )
		<< "\n\n< DWA : Weight >"
		<< "\n  * weight_heading         : " << pnh_.param<double>( "weight_heading", 1.0 )
		<< "\n  * weight_obstacle        : " << pnh_.param<double>( "weight_obstacle", 1.0 )
		<< "\n  * weight_velocity        : " << pnh_.param<double>( "weight_velocity", 2.0 )
		<< "\n\n< DWA : CostDistance >"
		<< "\n  * obstacle_cost_radius   : " << pnh_.param<double>( "obstacle_cost_radius", 0.35 )
		<< "\n\n< DWA : DisplayFlag >"
		<< "\n  * display_optimal_path   : " << ( pnh_.param<bool>( "display_optimal_path", false ) ? "True" : "False" )
		<< "\n  * display_all_path       : " << ( pnh_.param<bool>( "display_all_path", false ) ? "True" : "False" )
		<< "\n========================================\n"
	<< std::endl;
}
