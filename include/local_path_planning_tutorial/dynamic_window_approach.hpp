...
inline void local_path_planning_tutorial::DynamicWindowApproach::setTargetFrame ( const std::string& target_frame ) { dwap_->target_frame = target_frame; }

inline void local_path_planning_tutorial::DynamicWindowApproach::setVelocityLimit (
    const double min_vel,
    const double max_vel,
    const double min_ang_vel,
    const double max_ang_vel,
...
inline void local_path_planning_tutorial::DynamicWindowApproach::setWeight (
    const double heading,
    const double obstacle,
    const double velocity )
{
...
inline void local_path_planning_tutorial::DynamicWindowApproach::setCostDistance ( const double obstacle_cost_radius ) {
	dwap_->obstacle_cost_radius = obstacle_cost_radius;
}
inline void local_path_planning_tutorial::DynamicWindowApproach::setStepValue ( const int predict_step, const double sampling_time ) {
	dwap_->predict_step = predict_step;
	dwap_->sampling_time = sampling_time;
}
inline void local_path_planning_tutorial::DynamicWindowApproach::setDisplayFlag ( const bool display_optimal_path, const bool display_all_path) {
